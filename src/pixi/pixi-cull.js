         ...
         */
             ...
             */
				...
				value: function updateObject (object) {
					...
					var xStart = _getBounds.xStart;
					var yStart = _getBounds.yStart;
					var xEnd = _getBounds.xEnd;
					var yEnd = _getBounds.yEnd;
             ...
             */
				...
				value: function query (AABB, simpleTest) {
					...
					var xStart = _getBounds2.xStart;
					var yStart = _getBounds2.yStart;
					var xEnd = _getBounds2.xEnd;
					var yEnd = _getBounds2.yEnd;
             ...
             */
				...
				value: function queryCallback (AABB, callback, simpleTest) {
					...
					var xStart = _getBounds3.xStart;
					var yStart = _getBounds3.yStart;
					var xEnd = _getBounds3.xEnd;
					var yEnd = _getBounds3.yEnd;
