 ...
 */
   ...
   */
	...
	})(typeof module === 'object' ? module.exports : (this.io = {}), this);
	/**
 * socket.io
 * Copyright(c) 2011 LearnBoost <dev@learnboost.com>
 * MIT Licensed
 */
   ...
   */
		...
		util.request = function (xdomain) {
			if (xdomain && typeof XDomainRequest != 'undefined') {
   ...
   */
		...
		util.ua.webkit = typeof navigator != 'undefined' &&
   ...
   */
		...
		util.ua.iDevice = typeof navigator != 'undefined' &&
      /iPad|iPhone|iPod/i.test(navigator.userAgent);
	})(typeof io != 'undefined' ? io : module.exports, this);
 ...
 */
   ...
   */
		...
		Socket.prototype.getTransport = function (override) {
			var transports = override || this.transports; var match;
   ...
   */
		...
		Flashsocket.prototype.ready = function (socket, fn) {
			function init () {
				...
				var port = options['flash policy port'];
				var path = [
					`http${options.secure ? 's' : ''}:/`,
					`${options.host}:${options.port}`,
					options.resource,
