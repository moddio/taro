...
var IgeEditorComponent = IgeEventingClass.extend({
				...
				ige.on('allRequireScriptsLoaded', function () {
					...
					ige.on('syncComplete', function () {
						...
						setInterval(function () {
							...
							$('#editorFps').html(`${ige._renderFPS} fps`);
	...
	toggleShowEditor: function () {
		...
		if (this._showSgTree) {
			...
			var consoleElem = document.createElement('input');
			var classChainElem = document.createElement('div');
			...
			var editorModeTranslate = document.createElement('input');
			var editorModeRotate = document.createElement('input');
			var editorModeScale = document.createElement('input');
			var editorStatus = document.createElement('span');
