var UiAnimationEditor = IgeEventingClass.extend({
	...
	cellFromIndex: function (index) {
		index = index - 1;
		var self = this;
		var cellsPerRow = (self._textureImage.width / self._cellWidth);
		var y = Math.floor(index / cellsPerRow);
		var x = index - (y * cellsPerRow);
	...
	_renderCanvas: function (noGrid) {
		var self = this;
		var framesCtx = self._framesCtx;
		var cellsCtx = self._cellsCtx;
		var outputCtx = self._outputCtx;
		var cell;
		var cellWidth;
		var cellHeight;
		var x; var y; var i;
