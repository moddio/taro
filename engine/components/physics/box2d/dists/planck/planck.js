 ...
 */
		...
		/* 20 */ /***/ function (module, exports, __webpack_require__) {
			...
			PolygonShape.prototype.getVertex = function (index) {
				_ASSERT && common.assert(index >= 0 && index < this.m_count);
			...
			PolygonShape.prototype._set = function (vertices) {
				_ASSERT && common.assert(vertices.length >= 3 && vertices.length <= Settings.maxPolygonVertices);
			...
			PolygonShape.prototype.rayCast = function (output, input, xf, childIndex) {
				...
				_ASSERT && common.assert(lower >= 0.0 && lower <= input.maxFraction);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			ChainShape.prototype.getChildEdge = function (edge, childIndex) {
				_ASSERT && common.assert(childIndex >= 0 && childIndex < this.m_count - 1);
			...
			ChainShape.prototype.rayCast = function (output, input, xf, childIndex) {
				_ASSERT && common.assert(childIndex >= 0 && childIndex < this.m_count);
		...
		/* 29 */ /***/ function (module, exports, __webpack_require__) {
			...
			World._deserialize = function (data, context, restore) {
				...
				data.joints &&
                    data.joints.reverse().forEach(function (data) {
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			DynamicTree.prototype.getAreaRatio = function () {
				...
				var totalArea = 0.0;
				var node;
				var it = iteratorPool.allocate().preorder(this.m_root);
				while ((node = it.next())) {
					if (node.height < 0) {
						// Free node in pool
						continue;
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			Fixture.prototype.getAABB = function (childIndex) {
				_ASSERT && common.assert(childIndex >= 0 && childIndex < this.m_proxyCount);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			SeparationFunction.prototype.initialize = function (cache, proxyA, sweepA, proxyB, sweepB, t1) {
				...
				_ASSERT && common.assert(count > 0 && count < 3);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			Solver.prototype.solveIslandTOI = function (subStep, toiA, toiB) {
				...
				if (false) {
					var cache, output, input, indexB, indexA, bB, bA, fB, fA, c, i;
				}
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			function FindIncidentEdge (c, poly1, xf1, edge1, poly2, xf2) {
				...
				_ASSERT && common.assert(edge1 >= 0 && edge1 < poly1.m_count);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			function GearJoint (def, bodyA, bodyB, joint1, joint2, ratio) {
				...
				this.m_joint1 = joint1 || def.joint1;
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			MotorJoint.prototype.setCorrectionFactor = function (factor) {
				_ASSERT && common.assert(Math.isFinite(factor) && factor >= 0.0 && factor <= 1.0);
		...
		/***/ function (module, exports, __webpack_require__) {
			...
			function PulleyJoint (def, bodyA, bodyB, groundA, groundB, anchorA, anchorB, ratio) {
				...
				this.m_groundAnchorA = groundA || def.groundAnchorA || Vec2.neo(-1.0, 1.0);
				this.m_groundAnchorB = groundB || def.groundAnchorB || Vec2.neo(1.0, 1.0);
