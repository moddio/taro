 ...
 */
Body.prototype.createFixture = function(shape, fixdef, isLossTolerant) {
    _ASSERT && common.assert(this.isWorldLocked() == false);
    if (this.isWorldLocked() == true && !isLossTolerant) {
        return null;
    }
 ...
 */
World.prototype.rayCast = function(reportFixtureCallback,point1, point2) {
 ...
 */
World.prototype.createBody = function(def, angle,isLossTolerant) {
