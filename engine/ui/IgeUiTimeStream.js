var IgeUiTimeStream = IgeUiElement.extend({
	...
	tick: function (ctx) {
		...
		if (this._entity) {
			...
			ige.client.custom2.value = this._entity._keyFramesDataDelta;
			ige.client.custom3.value = this._entity._keyFramesOffsetDelta;
			ige.client.custom4.value = this._entity._keyFramesCurrentInterpolateTime;
		}
	}
});
